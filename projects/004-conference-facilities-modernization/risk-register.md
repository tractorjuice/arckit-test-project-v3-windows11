...
|---------|------|--------|---------|
| 1.0 | 2025-11-04 | ArcKit AI | Initial creation from `/arckit.risk` command |
...
*This risk register follows HM Treasury Orange Book (2023) principles and integrates with ArcKit's stakeholder-driven architecture governance framework. All risks are traceable to stakeholder drivers documented in stakeholder-drivers.md (ARC-004-STKE-v1.0).*
