...
**Generation Context**: Updated to latest template format (v4.0). Previous version (v3.0) was updated based on MOD Secure by Design Assessment findings. Stakeholder analysis available in stakeholder-drivers.md.
