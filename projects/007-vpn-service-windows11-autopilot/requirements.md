...
| Field | Value |
|-------|-------|
| **Document ID** | ARC-007-REQ-v1.0 |
| **Project** | VPN Service for Windows 11 and Autopilot |
| **Version** | 1.0 |
| **Status** | Draft |
...
|---------|------|--------|---------|
| 1.0 | 2026-01-09 | EA Team | Initial requirements specification |

### Reviewers and Approvers

| Role | Name | Status | Date |
|------|------|--------|------|
| Technical Architect | TBC | Pending | - |
| Security Architect | TBC | Pending | - |
| Infrastructure Lead | TBC | Pending | - |
